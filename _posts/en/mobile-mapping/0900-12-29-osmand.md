...
### F-Droid
Install the app from F-Droid by searching "OsmAnd" in the F-Droid app, or install by downloading the app through an Internet browser at [https://f-droid.org/repository/browse/?fdfilter=osmand&fdid=net.osmand.plus](https://f-droid.org/repository/browse/?fdfilter=osmand&fdid=net.osmand.plus).
